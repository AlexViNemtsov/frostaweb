...
function ht() {
  ...
  class e {
    ...
    runTask(s, i, r) {
      ...
      let E = s,
        { type: x, data: { isPeriodic: ee = !1, isRefreshable: M = !1 } = {} } =
          s;
    ...
    scheduleTask(s) {
      ...
      try {
        ...
        throw (
          (s._transitionTo(X, p, q), this._zoneDelegate.handleError(this, r), r)
        );
      }
      return (
    ...
    cancelTask(s) {
      ...
      if (!(s.state !== d && s.state !== A)) {
        ...
        try {
          ...
          throw (
            (s._transitionTo(X, V), this._zoneDelegate.handleError(this, i), i)
          );
        }
        return (
...
var tt = typeof WorkerGlobalScope < "u" && self instanceof WorkerGlobalScope,
  ...
  Xe = function (t) {
    ...
    if (Ge && a === be && t.type === "error") {
      let f = t;
      (c =
        e && e.call(this, f.message, f.filename, f.lineno, f.colno, f.error)),
...
function Ye(t, n, a) {
  let e = pe(t, n);
  if (
    (!e && a && pe(a, n) && (e = { enumerable: !0, configurable: !0 }),
    !e || !e.configurable)
  )
    return;
...
function ke(t, n, a, e) {
  ...
  function T(w) {
    ...
    return (
      Ke(P)
        ? (_.handleId = P)
        : ((_.handle = P), (_.isRefreshable = Je(P.refresh))),
      w
    );
  }
  function y(w) {
      ...
      if (h[p] === k) {
        ...
        if (
          ...
          if (
            ...
            let m =
              a.currentTask && a.currentTask.data && a.currentTask.data[L];
            m &&
              f(o, W, {
                configurable: !0,
                enumerable: !1,
            ...
            o[N].then(
              ...
              (Z) => {
                C.push(Z),
                  u--,
                  u === 0 &&
                    ((v = !0), O(new ee(C, "All promises were rejected")));
              }
            );
        });
      }
